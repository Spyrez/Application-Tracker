...
from db import insert_application, get_all_applications
...
class JobTrackerApp:
    def __init__(self, root):
        ...
        tk.Button(root, text="Add Application", command=self.add_application).grid(row=3, columnspan=2) # columnspan=2 to center the button
